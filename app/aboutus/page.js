export default function AboutUs() {
  return (
    <div className="container mt-5">
      ...
      <h1 className="mb-4">About Brain Fusion</h1>

      <p>
        Brain Fusion is an AI-powered medical assistance project designed to help in the early detection and prediction of Alzheimer’s disease.
      </p>
      ...
      <p>
        Brain Fusion aims to assist doctors and patients by providing fast, reliable, and AI-driven diagnostic insights for early-stage Alzheimer’s detection.
      </p>
